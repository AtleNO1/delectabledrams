...
export class DataService {
  ...
  //   {
  //     islay: [
  //       {name: 'Islay Whisky', url: './assets/images/gallery/islay0.jpg'},
  //       {name: 'Islay Whisky', url: './assets/images/gallery/islay1.jpg'},
  //       {name: 'Islay Whisky', url: './assets/images/gallery/islay2.jpg'}
  //     ],
  //     sherried: [
  //       {name: 'Sherried Whisky', url: './assets/images/gallery/sherried0.jpg'},
  //       {name: 'Sherried Whisky', url: './assets/images/gallery/sherried1.jpg'},
  //       {name: 'Sherried Whisky', url: './assets/images/gallery/sherried2.jpg'}
  //     ],
  //     world: [
